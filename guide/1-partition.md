...
>
> It is highly recommended to downgrade to OOS11 (or flash any custom ROM which uses OOS11 firmware) if you want to use Windows.
...
#### Recreating userdata
> Replace **#** with the former start value of **userdata** which we just deleted
>
> Replace **$** with the end value you want **userdata** to have. In this example your available usable space in Android will be #GB-$GB = **?GB**
```cmd
mkpart userdata ext4 #GB $GB
```

#### Creating ESP partition
> Replace **$** with the end value of **userdata**
>
> Replace **$.3GB** with the end value of **userdata**, adding **0.3GB** to it
```cmd
mkpart esp fat32 $GB $.3GB
```

#### Creating Windows partition
> Replace **$.3GB** with the end value of **esp** you just created 
```cmd
mkpart win ntfs $.3GB -0MB
```
